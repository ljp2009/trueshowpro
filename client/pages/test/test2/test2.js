...
Page({
  ...
  drawarea: function () {
    ...
    for (var i = 0; i < this.data.timedata.disabledarea.length; i++) {
      context.rect(this.data.timedata.disabledarea[i].x1x, 0, (this.data.timedata.disabledarea[i].x2x - this.data.timedata.disabledarea[i].x1x), 100)
    }
    ...
    ////////////////绿色框绘制
    for (var i = 0; i < this.data.timedata.currentorderarea.length; i++) {
      context.rect(this.data.timedata.currentorderarea[i].x1x, 0, (this.data.timedata.currentorderarea[i].x2x - this.data.timedata.currentorderarea[i].x1x), 100)
    }
